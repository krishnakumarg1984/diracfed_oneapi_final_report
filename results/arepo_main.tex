...
\end{figure}
To further test these findings, the Illustris 3 testcase [2] was used.
...
\begin{figure}[htp]
	\centering
	\includegraphics[clip,width=0.6\textwidth]{Arepo_blockingvsNonblocking.png}
...
With confirmation from the AREPO developers at the University of Cambridge we decided that at this stage it was not worth the effort to debug and fix the existing shared memory parallelization.
Giving us the opportunity to reevaluate our decision on using OpenMP 5 offload to using SYCL.
