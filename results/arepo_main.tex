...
For codes like Arepo, that are not yet targeting any accelerators SYCL/OneAPI provides efficient options in the sense of portability. The main problem is 
