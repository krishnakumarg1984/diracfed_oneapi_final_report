...
Intel onAPI Math Kernel Library offers an accelerator enabled version of Fast Fourier Transforms, as well as FFTW3 (and FFTW2) interface wrapper libraries to these functionalities.
...
The original intention was to expand the existing OpenMP paralllization to include offload capabilities, in line with the intel recommendation for C programs.
