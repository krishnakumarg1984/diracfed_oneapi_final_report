...
One problem detected is that the CMakeLists.txt file hasn't been adjusted accordingly with the dpct compatibility tool. The source files that were modified (extension changed to *.dp.cpp) were not updated. In our case this involves the following files:
\begin{verbatim}
./main.dp.cpp
