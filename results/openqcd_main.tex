...
\begin{center}
	\begin{table}
		\begin{tabular}{||c c c c c c c||}
			\hline
			Kernel & Compiler & Time [ms] & Compute [\%] & Memory [\%] & Registers & Occupancy [\%] \\
			\hline\hline
			mulpauli    & CUDA     & 4.85          & 16.07                   & 81.30                 & &  \\
			\hline
			mulpauli    & OneAPI   & 17.31         & 7.36                    & 70.89 & &                   \\
			\hline
			mulpauli    & hipSYCL  &          &                     &                   & &  \\
			\hline
			doe         & CUDA     & 7.57          & 15.78                   & 62.66 & &                   \\
			\hline
			doe         & OneAPI     & 17.34         & 7.31                    & 61.12 & &                   \\
			\hline
			doe         & hipSYCL     &          &                     &                    & & \\
			\hline
			deo         & CUDA     & 8.25          & 12.93                   & 54.88 & &                   \\
			\hline
			deo         & OneAPI     & 46.30         & 7.66                    & 27.24    & &                \\
			\hline
			deo         & hipSYCL     &          &                     &                  & &   \\
			\hline
		\end{tabular}
...
\todo{@Tuomas Update table with hipSYCL performance on NVidia A100's on Thursday. Expect similar performance to OneAPI}
